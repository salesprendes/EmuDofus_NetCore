...
namespace Game.Command
{
    ...
    {
        public sealed class TeleportCommand : WorldStaffSubCommand
        {
            ...
            {
                context.Character.Dispatch(WorldMessage.BASIC_CONSOLE_MESSAGE("Formato: character tele %mapId% %cellId%"));
            }
        }
    }
}
