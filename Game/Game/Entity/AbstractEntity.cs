        ...
        public bool CanGameAction(GameActionTypeEnum actionType)
        {
            ...
            switch (actionType)
            {
                ...
                case GameActionTypeEnum.MAP_MOVEMENT:
                    return (CurrentAction == null || CurrentAction.IsFinished) && !HasEntityRestriction(EntityRestrictionEnum.RESTRICTION_IS_TOMBESTONE);

                case GameActionTypeEnum.FIGHT_WEAPON_USE:
                case GameActionTypeEnum.FIGHT_SPELL_LAUNCH:
                    return (CurrentAction == null || CurrentAction.IsFinished) && HasGameAction(GameActionTypeEnum.FIGHT);
                ...
                case GameActionTypeEnum.PRISM_USE:
                    return (CurrentAction == null || CurrentAction.IsFinished)
                        && !HasPlayerRestriction(PlayerRestrictionEnum.RESTRICTION_CANT_INTERACT_WITH_PRISM)
                        && !HasEntityRestriction(EntityRestrictionEnum.RESTRICTION_IS_TOMBESTONE);
            }
