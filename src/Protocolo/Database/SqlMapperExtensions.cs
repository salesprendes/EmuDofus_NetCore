    ...
    ﻿  /// <summary>
      ...
      public static T Get<T>(this IDbConnection connection, dynamic id, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
      {
          ...
          if (!GetQueries.TryGetValue(type.TypeHandle, out sql))
          {
              ...
              sql = "select * from " + name + " where " + QuoteIdentifier(onlyKey.Name) + " = @id";
...
﻿  ﻿  ﻿  ﻿
				sbColumnList.AppendFormat("{0}", QuoteIdentifier(property.Name));
...
﻿  ﻿  ﻿
      ...
      public static int Update<T>(this IDbConnection connection, IEnumerable<T> entitiesToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
      {
          ...
          for (var i = 0; i < nonIdProps.Count(); i++)
          {
              ...
              sb.AppendFormat("{0} = @{1}", QuoteIdentifier(property.Name), property.Name);
      ...
      /// <param name="entityToUpdate">Entity to be updated</param>
      /// <returns>true if updated, false if not found or not modified (tracked entities)</returns>
      public static int UpdateTransactional<T>(this IDbConnection connection, IDbCommand cmd, IEnumerable<T> entitiesToUpdate, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
      {
          var type = typeof(T);
          ...
          return connection.ExecuteQueryMultiple(cmd, sb.ToString(), entitiesToUpdate, commandTimeout: commandTimeout, transaction: transaction);
      }
      /// <summary>
      /// Updates entity in table "Ts", checks if the entity is modified if the entity is tracked by the Get() extension.
      /// </summary>
    ...
    ﻿  public static class ProxyGenerator
       {
           ...
           {
               // .NET 10: AppDomain.DefineDynamicAssembly removed; use AssemblyBuilder.DefineDynamicAssembly static method.
