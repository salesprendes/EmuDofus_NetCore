...
namespace Game.Interactive
{
    ...
    public enum InteractiveObjectIdEnum
    {
        ...
        INTERACTIVE_SLIDING_ROCK = 201,
        INTERACTIVE_SLIDING_ROCK_INCARNAM = 202,
        INTERACTIVE_MINOS_BLUE_DOOR = 203,
        INTERACTIVE_MINOS_YELLOW_DOOR = 204,
    ...
    public abstract class InteractiveObject : MessageDispatcher
    {
        ...
        public virtual bool CanUseWithoutJobSkill(int skillId)
        {
            return false;
        }
    }
