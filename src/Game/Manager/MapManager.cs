...
namespace Game.Manager
{
    public sealed class MapManager : Singleton<MapManager>
    {
        ...
        private readonly HashSet<int> m_creationIds;
        ...
        public MapManager()
        {
            ...
            m_creationIds = new HashSet<int>(WorldConfig.MULTIPLE_INSTANCE_MAP_ID);
        ...
        public void Initialize()
        {
            foreach (var mapDAO in MapTemplateRepository.Instance.All)
            {
                ...
                if (m_creationIds.Contains(map.Id))
        ...
        {
            if (m_creationIds.Contains(instance.Id))
