...
namespace Game.Database.Structure
{
    ...
    public sealed class ItemTemplateDAO : DataAccessObject<ItemTemplateDAO>
    {
        ...
        private static int GetGeneratedEffectValue(RandomEffect effect, bool max)
        {
        ...
        public GenericStats GenerateStats(bool max = false)
        {
            ...
            if ((ItemTypeEnum)Type == ItemTypeEnum.TYPE_OBJET_VIVANT)
                ItemDAO.EnsureLivingReceptionStats(generatedStats, DateTime.Now);
